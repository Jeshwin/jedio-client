<template>
  <form
    class="w-5/6 min-w-max mx-auto pt-24"
    ...
    <div class="grid grid-cols-1 gap-y-4 rounded-3xl bg-gray-200">
      ...
      <div class="flex justify-between pl-16 -mt-28">
        ...
        <input
          type="submit"
          value="Confirm"
          class="cursor-pointer w-auto h-12 px-4 py-2 mr-10 mt-28 text-2xl font-semibold rounded-full text-green-600 ring-green-600 ring-4 hover:text-green-500 hover:ring-green-500 transition duration-200"
        />
      </div>
      ...
      <div
        class="flex justify-start pl-14 mb-4 text-2xl text-gray-800 font-quicksand"
      >
        <svg
